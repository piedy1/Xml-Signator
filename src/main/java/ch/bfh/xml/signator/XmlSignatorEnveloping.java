 ...
 *   <Object Id="object">
 *      <Order>
 *          <LineItem sku="12348">Web Service Security</LineItem>
...
public class XmlSignatorEnveloping {
    //
    ...
    public static void main(String[] args) throws Exception {
        ...
        Reference ref = fac.newReference("#object",
            fac.newDigestMethod(DigestMethod.SHA1, null), null, "http://www.w3.org/2000/09/xmldsig#Object", null);
        ...
        Element lineItem1 = doc.createElement("LineItem");
        lineItem1.setAttribute("sku", "12348");
        lineItem1.appendChild(doc.createTextNode("Web Service Security"));
        order.appendChild(lineItem1);
        
        Element lineItem2 = doc.createElement("LineItem");
        lineItem2.setAttribute("sku", "2345");
        lineItem2.appendChild(doc.createTextNode("Life as a Geek Book"));
        order.appendChild(lineItem2);
        
        XMLStructure content = new DOMStructure(order);
        ...
        if (args.length > 0) {
           ...
           os = new FileOutputStream("src/main/resources/ch/bfh/xml/output/object.xml");
        }
