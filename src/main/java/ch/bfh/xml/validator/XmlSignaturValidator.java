 ...
 * KeyValue KeyInfo.
 */
public class XmlSignaturValidator {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Document doc
                = dbf.newDocumentBuilder().parse(new FileInputStream("src/main/resources/ch/bfh/xml/output/signedPurchaseOrder2.xml"));
